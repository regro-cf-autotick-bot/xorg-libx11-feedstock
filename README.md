...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libx11-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libx11-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libx11
# for installing globally
pixi global install xorg-libx11
```
...
It is possible to list all of the versions of `xorg-libx11` available on your platform:
...
```
pixi search xorg-libx11 --channel conda-forge
```
